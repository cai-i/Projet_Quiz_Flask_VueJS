  ...
  <div :style="myStyle">
    ...
    <div class="mb-16 mt-8 mx-16 ">
      <div v-if="!this.loading">
        ...
        >
          <button
              class="px-1 py-1 mb-1 text-sky-700 align-middle rounded hover:bg-white hover:bg-opacity-50 hover:text-black"
              @click="
          ...
          <button
            class="px-1 py-1 mb-1 text-sky-700 rounded hover:bg-white hover:bg-opacity-50 hover:text-black"
            @click="
