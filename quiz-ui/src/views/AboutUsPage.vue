<template>
  ...
  <section class="py-11 bg-orange-100 h-full">
    <div class="w-5/6 mx-auto"> 
      ...
      <div class="mt-10 gap-3 justify-center items-center grid grid-cols-1 place-items-center lg:flex">
      ...
      <div class="mt-7 gap-3 justify-center items-center grid grid-cols-1 lg:flex">
